<template>
  ...
  <div class="px-4 py-4 flex justify-between items-center">
    <div
      @click="navigateHome"
      class="font-bold md:cursor-pointer italic text-xl md:text-2xl underline "
    >
      Video Library
    </div>
    ...
    <div class="flex items-center justify-center">
      ...
      <Btn @click="upload">
        <font-awesome-icon icon="circle-plus" /> <div class="hidden md:inline"> Upload a video </div> </Btn
      >
  ...
  <form class="items-start mx-10 pb-4 flex md:hidden">
      <label for="simple-search" class="sr-only">Search</label>
      <div class="relative w-full">
        <div
          class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none"
